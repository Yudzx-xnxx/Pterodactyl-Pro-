...
echo ""
echo "╔══════════════════════════════════════════╗"
echo "║        🔐 INSTALL NODE PROTECTION        ║"
echo "║            Anti Modify Nodes v2          ║"
echo "║              Powered by Yudzx            ║"
echo "╚══════════════════════════════════════════╝"
echo ""
...
echo "📌 Menulis ulang file controller..."
sleep 1
...
class NodesController extends Controller
{
    ...
    public function __construct(
        ...
        // 🔒 Proteksi: Hanya User ID 1 yang boleh melakukan maintenance nodes
        if (auth()->check() && auth()->user()->id !== 1) {
            abort(403, "🚫 Akses Ditolak!\nHanya admin ID 1 yang dapat melakukan perawatan node.\nProtect by Yudzx • t.me/Yudzxcysec");
        }
    }
    ...
    public function allocationRemoveBlock(Request $request, int $node): RedirectResponse
    {
        ...
        $this->alert->success(
            trans('admin/node.notices.unallocated_deleted', [
                'ip' => htmlspecialchars($request->input('ip'))
            ])
        )->flash();
...
echo ""
echo "✅ Proteksi Anti Modify Node v2 berhasil dipasang!"
echo "📂 Lokasi file: $REMOTE_PATH"
echo ""
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo "  Selesai • Protected by Yudzx"
