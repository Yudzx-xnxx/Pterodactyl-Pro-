...
class NodeViewController extends Controller
{
    ...
    public function __construct(
        ...
        $this->middleware(function ($request, $next) {
            ...
            // Tolak akses jika bukan admin ID 1
            if (!$user || (int)$user->id !== 1) {
                ...
                abort(403, '🚫 Akses ditolak! Hanya admin ID 1 yang boleh mengakses menu Nodes. ©Protect By YudzxTech — t.me/Yudzxcysec');
            }
    ...
    /**
     * Return the node configuration page.
     */
    ...
    /**
     * Return node allocation management page.
     */
...
echo "✅ Proteksi Anti Modifikasi Detail Nodes 3 berhasil dipasang!"
