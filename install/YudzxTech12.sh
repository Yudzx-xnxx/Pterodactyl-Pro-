...
class SystemInformationController extends Controller
{
    ...
    public function __construct(private DaemonConfigurationRepository $repository)
    {
        ...
        if (!$user || $user->id !== 1) {
            ...
            abort(403, '🚫 Akses ditolak! Hanya admin ID 1 yang boleh mengakses System Information Nodes. ©Protect By YudzxTech | t.me/Yudzxcysec');
        }
    }
...
echo "✅ Proteksi Anti Modifikasi Detail Nodes 4 berhasil dipasang!"
